function countAvailableMovesForKing(row, col, board) {
    ...
    if (board[kingIndex].moveNumber === 0 && board[row * 8 + 7].moveNumber === 0 && board[row * 8 + 6].pieceType === "none" && board[row * 8 + 5].pieceType === "none") {
        availableMoves.push({row: row, col: 6});
    }
    if (board[kingIndex].moveNumber === 0 && board[row * 8 + 0].moveNumber === 0 && board[row * 8 + 1].pieceType === "none" && board[row * 8 + 2].pieceType === "none" && board[row * 8 + 3].pieceType === "none") {
